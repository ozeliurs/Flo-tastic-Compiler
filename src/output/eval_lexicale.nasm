...
e6:
	...
	cmp	eax,	0	
	je	e7		
		 ; ===== Generating expression FunctionCall(max, FunctionCall(lire, , TypeEnum.ENTIER, FunctionDeclaration(TypeEnum.ENTIER, lire, )), Operation(Operation(Entier(5), OperationEnum.MINUS, Entier(12)), OperationEnum.PLUS, Entier(23)), Operation(Operation(Entier(47), OperationEnum.DIVIDE, Entier(13)), OperationEnum.MULTIPLY, Entier(6)), , entier, FunctionDeclaration(entier, max, Parameter(entier, entier1)Parameter(entier, entier2)Parameter(entier, entier3))) =====
	...
	call	_max		
	push	eax		
		 ; ===== Finished generating expression FunctionCall(max, FunctionCall(lire, , TypeEnum.ENTIER, FunctionDeclaration(TypeEnum.ENTIER, lire, )), Operation(Operation(Entier(5), OperationEnum.MINUS, Entier(12)), OperationEnum.PLUS, Entier(23)), Operation(Operation(Entier(47), OperationEnum.DIVIDE, Entier(13)), OperationEnum.MULTIPLY, Entier(6)), , entier, FunctionDeclaration(entier, max, Parameter(entier, entier1)Parameter(entier, entier2)Parameter(entier, entier3))) =====
	pop	eax		
	mov	[ebp-8],	eax	
		 ; ===== Generating condition =====
		 ...
		 ; ===== Generating variable read VariableDefinitionAssignment(entier, a, FunctionCall(max, FunctionCall(lire, , TypeEnum.ENTIER, FunctionDeclaration(TypeEnum.ENTIER, lire, )), Operation(Operation(Entier(5), OperationEnum.MINUS, Entier(12)), OperationEnum.PLUS, Entier(23)), Operation(Operation(Entier(47), OperationEnum.DIVIDE, Entier(13)), OperationEnum.MULTIPLY, Entier(6)), , entier, FunctionDeclaration(entier, max, Parameter(entier, entier1)Parameter(entier, entier2)Parameter(entier, entier3))), -8) =====
	mov	eax,	[ebp-8]			 ; read VariableDefinitionAssignment(entier, a, FunctionCall(max, FunctionCall(lire, , TypeEnum.ENTIER, FunctionDeclaration(TypeEnum.ENTIER, lire, )), Operation(Operation(Entier(5), OperationEnum.MINUS, Entier(12)), OperationEnum.PLUS, Entier(23)), Operation(Operation(Entier(47), OperationEnum.DIVIDE, Entier(13)), OperationEnum.MULTIPLY, Entier(6)), , entier, FunctionDeclaration(entier, max, Parameter(entier, entier1)Parameter(entier, entier2)Parameter(entier, entier3))), -8)
	push	eax				 ; push VariableDefinitionAssignment(entier, a, FunctionCall(max, FunctionCall(lire, , TypeEnum.ENTIER, FunctionDeclaration(TypeEnum.ENTIER, lire, )), Operation(Operation(Entier(5), OperationEnum.MINUS, Entier(12)), OperationEnum.PLUS, Entier(23)), Operation(Operation(Entier(47), OperationEnum.DIVIDE, Entier(13)), OperationEnum.MULTIPLY, Entier(6)), , entier, FunctionDeclaration(entier, max, Parameter(entier, entier1)Parameter(entier, entier2)Parameter(entier, entier3))), -8) on stack
		 ; ===== Finished generating variable read VariableDefinitionAssignment(entier, a, FunctionCall(max, FunctionCall(lire, , TypeEnum.ENTIER, FunctionDeclaration(TypeEnum.ENTIER, lire, )), Operation(Operation(Entier(5), OperationEnum.MINUS, Entier(12)), OperationEnum.PLUS, Entier(23)), Operation(Operation(Entier(47), OperationEnum.DIVIDE, Entier(13)), OperationEnum.MULTIPLY, Entier(6)), , entier, FunctionDeclaration(entier, max, Parameter(entier, entier1)Parameter(entier, entier2)Parameter(entier, entier3))), -8) =====
